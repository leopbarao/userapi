...
public class UserAPIExceptionHandler {
	...
	public ResponseEntity<UserAPIStandardError> objectNotFound(UserAPIObjectNotFoundException e,
	...
	public ResponseEntity<UserAPIStandardError> dataIntegrity(UserAPIDataIntegrityException e,
			HttpServletRequest request) {
	...
	@ExceptionHandler(UserAPIAuthorizationException.class)
	public ResponseEntity<UserAPIStandardError> forbidden(UserAPIAuthorizationException e,
			HttpServletRequest request) {

		UserAPIStandardError error = new UserAPIStandardError(LocalDateTime.now(), HttpStatus.FORBIDDEN.value(),
	...
	public ResponseEntity<UserAPIValidationError> dataValidation(MethodArgumentNotValidException e,
			HttpServletRequest request) {

		UserAPIValidationError error = new UserAPIValidationError(LocalDateTime.now(),
				HttpStatus.UNPROCESSABLE_ENTITY.value(), "Data validation", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<UserAPIStandardError> invalidArgument(MethodArgumentTypeMismatchException e,
			HttpServletRequest request) {
		UserAPIStandardError error = new UserAPIStandardError(LocalDateTime.now(), HttpStatus.BAD_REQUEST.value(),
	...
	public ResponseEntity<UserAPIStandardError> invalidMessage(HttpMessageNotReadableException e,
			HttpServletRequest request) {
		UserAPIStandardError error = new UserAPIStandardError(LocalDateTime.now(), HttpStatus.BAD_REQUEST.value(),
